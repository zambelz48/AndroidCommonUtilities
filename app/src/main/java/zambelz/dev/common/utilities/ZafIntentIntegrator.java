 ...
 * @author gcstang
 */
public class ZafIntentIntegrator {

	public static final int REQUEST_CODE	= 0x0000c0de; // Only use bottom 16 bits
	private static final String TAG 		= ZafIntentIntegrator.class.getSimpleName();
	...
	public ZafIntentIntegrator(Activity activity) {
	 ...
	 *         else an {@link ZafIntentResult} containing the result of the scan.
	 *         If the user cancelled scanning, the fields will be null.
	 */
	public static ZafIntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == REQUEST_CODE) {
			if (resultCode == Activity.RESULT_OK) {
				...
				return new ZafIntentResult(contents, formatName, rawBytes, orientation, errorCorrectionLevel);
			}
			return new ZafIntentResult();
		}
		return null;
	}
