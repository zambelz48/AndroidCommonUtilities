 ...
 * {@link ZafIntentIntegrator}.&lt;/p&gt;
 * 
 * @author Sean Owen
 */
public final class ZafIntentResult {
	...
	ZafIntentResult(String contents, String formatName, byte[] rawBytes, Integer orientation, String errorCorrectionLevel) {
